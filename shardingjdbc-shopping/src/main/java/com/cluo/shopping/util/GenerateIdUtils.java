package com.cluo.shopping.util;
...
public class GenerateIdUtils {
    ...
    public GenerateIdUtils(String machineId) {
    ...
    // 示例
    private static GenerateIdUtils instance = new GenerateIdUtils(myid);
    public static GenerateIdUtils getInstance() {
        return instance;
    }
    ...
    public static  String getGenerateNumber() {
       return GenerateIdUtils.getInstance().nextId();
    }
    ...
    public static void main(String[] args) {
        GenerateIdUtils orderId= GenerateIdUtils.getInstance();
